...
const ViewEmail = () => {
    ...
    return (
        <Box style={openDrawer ? { marginLeft: 250, width: '100%' } : { width: '100%' } }>
            <IconWrapper>
                <ArrowBack fontSize='small' color="action" onClick={() => window.history.back() } style={{cursor:'pointer'}} />
                <Delete fontSize='small' color="action" style={{ marginLeft: 40,cursor:'pointer' }} />
            </IconWrapper>
